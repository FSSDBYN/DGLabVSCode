...
export class WSClient {
    ...
    public getConfig() {
        ...
        return {
            ...
            maxStrength:config.get("maxStrength"),
    ...
    public async sendFireMessage(wave: any, strength: number, time: number) {
        ...
        let fireStrength = (strength + orS > config.maxStrength) ? config.maxStrength : strength + orS ;
        this.setStrength(1, 4, fireStrength);
        this.setStrength(2, 4, fireStrength);
